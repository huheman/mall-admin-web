  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="商品品牌：" v-show="false">
          ...
          <el-form-item label="审核状态：" v-show="false">
    ...
    <div class="table-container">
      <el-table ref="productTable" :data="list" style="width: 100%" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="所属游戏" width="100" align="center">
          <template slot-scope="scope">{{formatGame(scope.row.productCategoryId)}}</template>
        </el-table-column>
        ...
        <el-table-column label="货号/规格/售价/活动价"  align="center">
          <template slot-scope="scope">
            <template v-for="item in scope.row.skuInfo">
              <p>{{item.skuCode+'/'+format(item.spData)+'/'+item.price+'/'+(item.promotionPrice?item.promotionPrice:"-")}}</p>
            </template>
          </template>
        </el-table-column>
        <el-table-column label="营销活动"  align="center">
          <template slot-scope="scope">
            {{formatPromotionType(scope.row.promotionType)}}
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            <p>
              <el-button v-show="false" size="mini" @click="handleShowProduct(scope.$index, scope.row)">查看
              </el-button>
              <el-button size="mini" @click="handleUpdateProduct(scope.$index, scope.row)">编辑
              </el-button>
            </p>
            <p>
              <el-button v-show="false" size="mini" @click="handleShowLog(scope.$index, scope.row)">日志
              </el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      formatGame(categoryId){
         let c =this.productCateOptions[0].children.filter(c=>{
      ...
      format(spData){
        let result = []
        for(let one of JSON.parse(spData)){
